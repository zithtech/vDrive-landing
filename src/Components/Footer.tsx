    ...
    <footer className="footer" id="footer">
      ...
      <div className="footers">
        <div className="footer-main">
          ...
          <div className="footer-column">
            ...
            <p className="footer-description">
              Transform operational complexity into organized workflows, measurable outcomes, and
              scalable success.
            </p>
          ...
          <div className="footer-column">
            ...
            <div className="location-wrapper">
              <img
                src="/images/Gemini_Generated_Image_x9m40ex9m40ex9m4-removebg-preview.png"
                alt="India Flag"
        ...
        <div className="footer-bottom-wrapper">
          ...
          <p className="footer-copyright">Copyright © 2026 VDrive | All Rights Reserved</p>
        </div>

        {/* Floating Taxi Car */}
        <div className="footer-car-container">
          <img
            src="/images/Gemini_Generated_Image_a4o9a8a4o9a8a4o9-removebg-preview.png"
